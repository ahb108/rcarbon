...
#' medCal(x)
#' @seealso \code{\link[rcarbon]{calibrate}}, \code{\link[rcarbon]{barCodes}}
#' @export
medCal <- function(x)
{
...
#' @return A three-column matrix containing calibrated year BP, uncalibrated age bp, and standard deviation. To be used as custom calibration curve for the \code{\link[rcarbon]{calibrate}} function.
