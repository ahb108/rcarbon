...
#' @param bracket Controls handling of edge effects in simulations, by applying the fitted model to a slaightly larger calendar range. The default is sensible in most cases. Ignored for \code{model='custom'}.
