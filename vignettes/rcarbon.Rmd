...
```{r,results='hide'}
xx <- calibrate(x=c(5700,4820,6450,7200),errors=c(30,40,40,30),calCurves='intcal20')
```
```{r}
summary(xx)
```
...
DK.caldates=calibrate(x=DK$C14Age,errors=DK$C14SD,calCurves='intcal20',ncores=3) #running calibration over 3 cores
