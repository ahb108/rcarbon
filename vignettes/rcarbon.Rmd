...
```{r,results="hide",fig.height=5,fig.width=5}
binsense(x=DK.caldates,y=DK,h=seq(0,500,100),timeRange=c(8000,4000),sitecol='SiteID',agecol='C14Age') 
```
...
The grey shaded region represents a critical envelope encompassing the middle 95% of the simulated SPDs, with red and blue regions highlighting portions of the SPD where positive and negative deviations are detected. 
